...
<div class="form">
	...
	<div>
		...
		<?php echo $form->textField($model,'RegistrationDateTime', array('disabled'=>true)); ?>
		<?php echo $form->error($model,'RegistrationDateTime'); ?>
	</div>

	<div>
		<?php echo $form->labelEx($model,'ServiceID'); ?>
		<?php echo $form->dropDownList($model,'ServiceID', Services::getServicesList(), array('disabled'=>true) ); ?>
		<?php echo $form->error($model,'ServiceID'); ?>
	</div>

	<? if( $model->ServiceID != Services::LOCAL_USER ): ?>
	<div>
